 ...
 */
class LinkedListRemoveExplicado {
     ...
     */
    public LinkedListRemoveExplicado() {
    ...
    public static void main(String[] args) {
        LinkedListRemoveExplicado list = new LinkedListRemoveExplicado();
        list.append(10);
        list.append(20);
        list.append(30);
        list.append(40);
        ...
        System.out.println("Removed node: " + removed.value);
        list.printList();
        ...
        // Test 3: Remove last
        System.out.println("\nRemoving from index " + (list.getLength() - 1) + ":");
        removed = list.remove(list.getLength() - 1);
        System.out.println("Removed node: " + removed.value);
        list.printList();

        // Test 4: Invalid index
        System.out.println("\nAttempting to remove from index 5:");
        removed = list.remove(5);
        System.out.println("Removed node: " + (removed != null ? removed.value : "null"));
        System.out.println("Removed node: " + (removed != null ? removed.value : "null"));
    }
}
