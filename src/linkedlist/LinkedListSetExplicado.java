...
class LinkedListSetExplicado {
    ...
    public static void main(String[] args) {
        LinkedListSetExplicado lista = new LinkedListSetExplicado();
        ...
        lista.printList();  // Lista: 10 20 30 40

        // Teste 1: Atualização válida
        boolean resultado1 = lista.set(2, 35);
        System.out.println("\nAtualização no índice 2 (válido): " + resultado1);
        lista.printList();  // Lista: 10 20 35 40

        // Teste 2: Atualização inválida (índice negativo)
        boolean resultado2 = lista.set(-1, 100);
        System.out.println("\nAtualização no índice -1 (inválido): " + resultado2);

        // Teste 3: Atualização inválida (índice maior que tamanho)
        boolean resultado3 = lista.set(10, 200);
        System.out.println("Atualização no índice 10 (inválido): " + resultado3);
    }
}
